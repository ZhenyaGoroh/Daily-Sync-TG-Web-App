...
bot.command("quit", function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: 
            // Explicit usage
            return [4 /*yield*/, ctx.telegram.leaveChat(ctx.message.chat.id)];
            case 1:
                // Explicit usage
                _a.sent();
        ...
        switch (_a.label) {
            case 0: return [4 /*yield*/, ctx.telegram.sendMessage(ctx.message.chat.id, "Hello ".concat(ctx.from.username), {
                    reply_markup: telegraf_1.Markup.inlineKeyboard([
                        telegraf_1.Markup.button.callback("Click me", "hey_there"),
                    ]).reply_markup,
                })];
            case 1:
                _a.sent();
...
bot.action("hey_there", function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, ctx.reply("Hey Natasha!")];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
bot.on("callback_query", function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: 
            // Explicit usage
            return [4 /*yield*/, ctx.telegram.answerCbQuery(ctx.callbackQuery.id)];
            case 1:
                // Explicit usage
                _a.sent();
                // Using context shortcut
